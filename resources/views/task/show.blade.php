            ...
            <div class="task_wrap">
                <div class="info_row">
                    <div class="info_item show">
                        <img src="/assets/images/menu-boxed-2.svg" alt="ico">
                        <span class="show">{{ $task->id }}</span>
                    </div>
                    <div class="info_item show">
                        <img src="/assets/images/comment-2.svg" alt="ico">
                        <span class="show">{{ count($comments) }}</span>
                    </div>
                    <div class="info_item">
                        <img src="/assets/images/calendar-2.svg" alt="ico">
                ...
                <div class="card_action_row">
                    ...
                    <div class="card_action_item">
                        <img src="/assets/images/next.svg" alt="next_ico">
                    </div>
                </div>
            </div>
